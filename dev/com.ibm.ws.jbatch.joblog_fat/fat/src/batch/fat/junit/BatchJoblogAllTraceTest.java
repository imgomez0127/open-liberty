 ...
 *
 */
public class BatchJoblogAllTraceTest {
    ...
    private static final LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.jbatch.joblog.fat.trace");
    ...
    public void testBasicJobLogging() throws Exception {
        ...
        BatchJoblogFatUtils.verifyJobMessages(server, traceFile);
        BatchJoblogFatUtils.verifyStepMessages(server, traceFile, step1);
    ...
    public void testFailingPartitionedJobLogging() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            BatchJoblogFatUtils.verifyExceptionMessage(server, traceFile, "CWWKY0030I: An exception occurred");
    ...
    public void testSplitFlowJobLogging() throws Exception {
        ...
        BatchJoblogFatUtils.verifyStepMessages(server, traceFile, stepB2);
    ...
    public void testFailingSplitFlowJobLogging() throws Exception {
        ...
        BatchJoblogFatUtils.verifyExceptionMessage(server, traceFile, "CWWKY0034I: An exception occurred");
    ...
    public void testChunkJobLogging() throws Exception {
        ...
        BatchJoblogFatUtils.verifyChunkMessages(server, traceFile, step1);
