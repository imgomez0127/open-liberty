...
public class BatchJoblogConfig1Test {

    private static final String appName = "batchFAT";
    private static final String SUCCESS_MESSAGE = "TEST PASSED";

    private static final LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.jbatch.joblog.config1.fat");
    ...
    private static void log(String method, Object msg) {
        Log.info(BatchJoblogConfig1Test.class, method, String.valueOf(msg));
    }
