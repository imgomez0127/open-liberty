...
public class BatchJoblogConfig3Test {

    private static final String appName = "batchFAT";
    private static final String SUCCESS_MESSAGE = "TEST PASSED";

    private static final LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.jbatch.joblog.config3.fat");
    ...
    private static void log(String method, Object msg) {
        Log.info(BatchJoblogConfig3Test.class, method, String.valueOf(msg));
    }
